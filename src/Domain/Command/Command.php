 ...
 * - execute regular Unix commands like `composer update`
 ...
 *
 * Commands are considered as part of the domain as we DO need them to migrate the PIM data. However, the way are launched (locally, over SSH,, on a Symfony 2.x vs Symfony 3.0) are part of the infrastructure).
 *
