...
namespace spec\Akeneo\PimMigration\Domain\MigrationStep\s10_SourcePimConfiguration;

use Akeneo\PimMigration\Domain\FileFetcher;
use Akeneo\PimMigration\Domain\MigrationStep\s10_SourcePimConfiguration\SourcePimConfigurator;
