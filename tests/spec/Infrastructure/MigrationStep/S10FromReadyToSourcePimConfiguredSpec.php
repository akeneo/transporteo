...
use Akeneo\PimMigration\Infrastructure\MigrationStep\S10FromReadyToSourcePimConfigured;
 ...
 */
class S10FromReadyToSourcePimConfiguredSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(S10FromReadyToSourcePimConfigured::class);
    }
