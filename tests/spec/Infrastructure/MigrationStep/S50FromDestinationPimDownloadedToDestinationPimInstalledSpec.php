...
use Akeneo\PimMigration\Infrastructure\MigrationStep\S50FromDestinationPimDownloadedToDestinationPimInstalled;
 ...
 */
class S50FromDestinationPimDownloadedToDestinationPimInstalledSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(S50FromDestinationPimDownloadedToDestinationPimInstalled::class);
    }
