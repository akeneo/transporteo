...
use Akeneo\PimMigration\Infrastructure\StateMachineTransition\FromDestinationPimJobMigratedToDestinationPimExtraDataMigrated;
 ...
 */
class FromDestinationPimJobMigratedToDestinationPimExtraDataMigratedSpec extends ObjectBehavior
{
    public function let(
    ...
    {
        $this->shouldHaveType(FromDestinationPimJobMigratedToDestinationPimExtraDataMigrated::class);
    }
    ...
    public function it_migrates_system(
        ...
        $translator->trans('from_destination_pim_job_migrated_to_destination_pim_extra_data_migrated.message')->willReturn($transMessage);
